    ...
    while True:
        ...
        for x in range(amount):
            ...
            if mode == "+":
                ...
                # Adds incorrect problems to list.
                if answer != correct_answer:
                    questions.append(int1)
                    questions.append(int2)
        ...
        # Asks if user wants to review questions.
        choice = input("| Do you want to review incorrect question? Y/N\n ")

        if choice == "y":
            print("| The questions will be reviewed 25 times. ")
